...
/**
 * View Model for managing logic on the "Followers" screen.
 */
@HiltViewModel
class UserFollowersViewModel @Inject constructor(
    ...
    /**
     * Load the next page of the user's followers or the first page if no users have been loaded.
     */
    fun loadUserFollowers(username: String) {
        ...
        viewModelScope.runOnIO({
            val nextUsers = userRepository.getFollowers(username, currentPage)
